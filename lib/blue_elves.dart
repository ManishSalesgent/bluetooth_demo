...
class BlueElvesScreen extends StatefulWidget {
  const BlueElvesScreen({Key? key}) : super(key: key);

  @override
  State<BlueElvesScreen> createState() => _BlueElvesScreenState();
}

class _BlueElvesScreenState extends State<BlueElvesScreen> {
              ...
              : [
                  TextButton.icon(
                    ...
                    icon: Icon(_iosBlueState == IosBluetoothState.poweredOn
                        ...
                        : Icons.error),
                    label: Text(
                        "BlueToothState:${_iosBlueState.toString().replaceAll(RegExp("IosBluetoothState."), "")}",
                        ...
                        children: [
                          ...
                          StreamBuilder<int>(
                              ...
                              builder: (BuildContext context,
                                ...
                                return Text(
                                    "${snapshot.connectionState == ConnectionState.active ? snapshot.data.toString() : currentConnected._device.rssi.toString()}dBm",
                                    style: const TextStyle(
                    ...
                    Expanded(
                      ...
                      child: Column(children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            print("${currentConnected._device.toString()}");
                            print("${currentConnected._macAddress}");
                            print("${currentConnected._name}");
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) {
                            ...
                            children: [
                              Text(currentHide.name ?? "Unnamed device",
                                  style: const TextStyle(
                                      color: Colors.black, fontSize: 16)),
                              Text(
                                  "${currentHide.uuids.length} Service Advertised",
                                  style: const TextStyle(
                              ...
                              ElevatedButton(
                                  onPressed: () {
                                    Device toConnectDevice = currentHide
                                        .connect(connectTimeout: 10000);
                                    toConnectDevice.deviceSignalResultStream
                                        .listen((result) {});
                                    print("result-->$toConnectDevice");
                          ...
                          children: [
                            Text(currentScan.name ?? "Unnamed device",
                                style: const TextStyle(
                                    color: Colors.black, fontSize: 16)),
                            Text(
                                "${currentScan.uuids.length} Service Advertised",
                                style: const TextStyle(
                                    color: Colors.grey, fontSize: 12)),
                            Text(
